...
export const fetchReportes = async (token) => {
  try {
    const res = await api.get("api/v1/admin/reportes");
...
export const generarReporteEstudiantes = async (filtros, token) => {
  try {
    const res = await api.post("api/v1/admin/reportes/estudiantes", filtros);
    return res.data;
  } catch (error) {
...
export const generarReporteProfesores = async (filtros, token) => {
  try {
    const res = await api.post("api/v1/admin/reportes/profesores", filtros);
    return res.data;
  } catch (error) {
...
export const generarReporteClases = async (filtros, token) => {
  try {
    const res = await api.post("api/v1/admin/reportes/clases", filtros);
    return res.data;
  } catch (error) {
